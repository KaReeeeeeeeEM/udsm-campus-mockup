...
const NotificationCard: React.FC<SuggestionProps> = ({
  username,
  title,
  description,
  avatarSrc,
  ...
  return (
    <Card className="w-full p-2 bg-neutral-800 rounded-lg hover:bg-neutral-700 transition-all ease-in-out duration-300">
      <CardHeader className="justify-between">
        ...
        <Button
          className={
            isFollowed
              ? "bg-neutral-400 text-foreground border-default-200"
              : "bg-blue-400"
          }
          color="primary"
          radius="full"
